...
import { Calendar, MapPin, Ticket, User, LayoutDashboard, Home, LogOut } from "lucide-react";
...
// Member 2
const EventsPage = () => <div className="p-10 text-center"><h2>Events Management (Member 2)</h2></div>;
// Member 3
